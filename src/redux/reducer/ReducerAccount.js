...
export function reducerAccount(state = initialState, action) {
    switch (action.type) {
        ...
        case actionAccounts.USER_SINGLE_REQUEST:
            state.response = false;
            state.responseOK = false;
            state.responseData = '';
            state.loading = true;
            return state;
        case actionAccounts.USER_SINGLE_SUCCESS:
            state.response = true;
            state.responseOK = true;
            state.responseData = action.body;
            state.loading = false;
            state.userSingle = action.body;
            return state;
        case actionAccounts.USER_SINGLE_FAILURE:
            state.response = true;
            state.responseOK = false;
            state.responseData = action.data.message;
            state.loading = false;
        ...
        case actionAccounts.USER_DELETE_REQUEST:
            state.response = false;
            state.responseOK = false;
            state.responseData = '';
            state.loading = true;
            return state;
        case actionAccounts.USER_DELETE_SUCCESS:
            state.response = true;
            state.responseOK = true;
            state.responseData = action.body;
            state.loading = false;
            return state;
        case actionAccounts.USER_DELETE_FAILURE:
            state.response = true;
            state.responseOK = false;
            state.responseData = action.data.message;
            state.loading = false;
        ...
        case actionAccounts.USER_UPDATE_ENTIRE_REQUEST:
            state.response = false;
            state.responseOK = false;
            state.responseData = '';
            state.loading = true;
            return state;
        case actionAccounts.USER_UPDATE_ENTIRE_SUCCESS:
            state.response = true;
            state.responseOK = true;
            state.responseData = action.body;
            state.loading = false;
            return state;
        case actionAccounts.USER_UPDATE_ENTIRE_FAILURE:
            state.response = true;
            state.responseOK = false;
            state.responseData = action.data.message;
            state.loading = false;
